// Proper QR Code generator implementation
// Based on QR Code specification with error correction
...
(function() {
    ...
    // QR Code class
    function QR(typeNumber, errorCorrectLevel) {
    ...
    QR.prototype = {
        ...
        makeImpl: function(test, maskPattern) {
            ...
            if (this.dataCache == null) {
                this.dataCache = QR.createData(this.typeNumber, this.errorCorrectLevel, this.dataList);
            }
    ...
    // Create data
    QR.createData = function(typeNumber, errorCorrectLevel, dataList) {
        ...
        return QR.createBytes(buffer, rsBlocks);
    };
    
    QR.createBytes = function(buffer, rsBlocks) {
        let offset = 0;
        let maxDcCount = 0;
        let maxEcCount = 0;
